...
<%@ page import="gov.nih.nci.evs.valueseteditor.beans.UserSessionBean" %>
<%@ page import="gov.nih.nci.evs.valueseteditor.beans.IteratorBeanManager" %>
    ...
    <tr>
      ...
      <td class="textbody" align=right>
        ...
        <%
          ...
          int sliding_window_half_width = 5;//NCItBrowserProperties.getSlidingWindowHalfWidth();
