...
<%!
  private static Logger _logger = Utils.getJspLogger("comp_obj_coding_scheme_references.jsp");
%>
...
%>
          ...
          <table>
            <tr>
            <td class="texttitle-blue">Resolve Component Set:&nbsp;<%=ComponentObjectLabel%>&nbsp; (<%=ComponentDescription%>)</td>
            </tr>
...
<%
            ...
            <td>&nbsp;</td>
                  ...
                  <tr>
                  <td>
                        <h:commandButton id="continue_resolve" value="continue_resolve" action="#{ComponentBean.continueResolveComponentSubsetAction}"
			...
			<h:commandButton
				id="Cancel"
				value="Cancel"
				action="#{ComponentBean.cancelResolveComponentSubsetAction}" 
				image="#{form_requestContextPath}/images/cancel.gif" alt="Cancel Resolve Component Set">
			</h:commandButton>
